...
function usage() {
  return {
    usage:
      "node scripts/list-platform-phone-numbers.mjs [--page <n>] [--per-page <n>] [--phone-number-id <id>] [--business-account-id <id>]",
...
async function main() {
  ...
  try {
    ...
    return printResult(
      err("Failed to list platform WhatsApp phone numbers", {

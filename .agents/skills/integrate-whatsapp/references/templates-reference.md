...
```json
{
  ...
  "example": {
    "header_text_named_params": [{ "param_name": "sale_date", "example": "December 1" }]
  }
}
```
...
{
  "type": "body",
  "parameters": [{ "type": "text", "parameter_name": "order_id", "text": "ORDER-123" }]
}
```
...
{
  "type": "header",
  "parameters": [{ "type": "image", "image": { "id": "4490709327384033" } }]
}
```

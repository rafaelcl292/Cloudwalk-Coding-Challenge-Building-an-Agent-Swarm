...
Use retrieveKnowledge for knowledge routes, webSearch for general_web routes, and getCustomerProfile plus getRecentTransactions for support routes. Prefer support when the message mentions "my account", "transfer", "sign in", "blocked", "not able", "failed", or "can't".`,
  });
}
